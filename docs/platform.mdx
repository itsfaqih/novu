---
title: Novu Platform - Open-Source Notification Infrastructure
description: "Novu is an open-source notification infrastructure for sending in-app, email, SMS, push, and chat messages from one API with 60+ provider integrations."
...
<Columns cols={3}>
  ...
  <Card title="Svelte Quickstart" icon="/images/icons/svelte.svg" href="/platform/quickstart/svelte">
    Embed Novu Inbox with @novu/js in a Svelte or SvelteKit app.
  </Card>
</Columns>
